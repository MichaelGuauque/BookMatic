package com.bookmatic.Principal;

import com.bookmatic.DTO.AutorDTO;
import com.bookmatic.DTO.Datos;
...
public class Principal {
    ...
    public void busquedaLibro(){
        ...
        if(libroOptional.isPresent()){
            ...
            var json = consumoApi.buscarLibro(URL_API+nombreLibro.replace(" ", "%20"));
...
//              Guardar libro en la base de datos
    ...
    public Autor builderAutor(AutorDTO autor){
        ...
        autorPersistir.setFechaFallecimiento(autor.fechaDeDefuncion());
